# Welcome to create-eth-mobile Contributing Guide

Thank you for investing your time in contributing to create-eth-mobile!
...
The goal of create-eth-mobile is to be a "toolkit creator", using ETH Mobile as the base to provide the primary building blocks for a mobile dApp. In the future we plan to add "curated" extensions and the possibility to import 3rd party packages (that follow our standard).
...
Scan through our [existing issues](https://github.com/eth-mobile/create-eth-mobile/issues) to find one that interests you.
...
1. Fork the repo
2. Clone the project
3. Create a new branch (based on create-eth-mobile main branch) with a descriptive name
...
> ⚠️ **Important.** Please make sure to choose **create-eth-mobile** repo when you create your branch and compare your changes.
...
Since we're currently in early development, all changes should be marked as a minor/patch release to keep us within the `v0.x` range.
